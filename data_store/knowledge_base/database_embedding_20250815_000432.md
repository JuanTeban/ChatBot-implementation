...
#### UNIQUE VALUES:
- **modulo:** BCM, FM, FI, MM, AA, EW, GR, PAPM, TX, TR, GL, AR, RE, TRM , AP
- **categoria_de_defecto:** Legados, 0, Desarrollo, Configuración, Maestros, Control de cambio, Roles y perfiles, Funcionales
- **estado_de_defecto:** Propuesta de solución, En tratamiento, Nuevo, Acción responsable test
- **frente:** FINANCIERO, NO FINANCIERO , TECNICO, FINANCIERO , ET, NO FINANCIERO
